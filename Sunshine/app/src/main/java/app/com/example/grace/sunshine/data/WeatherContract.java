...
public class WeatherContract {
    ...
    public static final String CONTENT_AUTHORITY = "app.com.example.grace.sunshine";
    ...
    public static long normalizeDate(long startDate) {
        Time time = new Time();
        time.set(startDate);
        int julianStartDay = Time.getJulianDay(startDate, time.gmtoff);
        return time.setJulianDay(julianStartDay);
    }
    ...
    public static final class WeatherEntry implements BaseColumns {
        ...
        public static Uri buildWeatherLocationWithDate(String locationString, long date) {
            return CONTENT_URI.buildUpon().appendPath(locationString).appendPath(Long.toString(normalizeDate(date))).build();
        }
